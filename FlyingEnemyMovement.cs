...
{
    public static FlyingEnemyMovement instance;
    ...
    private void Start()
    {
        target = WaypointsFlying.points[0];
        health = starthealth;
    ...
    {
        if (wavepointIndex >= WaypointsFlying.points.Length - 1)
        {
            EndPath();
            return;
        }
        ...
        wavepointIndex++;
        target = WaypointsFlying.points[wavepointIndex];
    }
